...
/* global WebImporter */
/**
 * Parser for ad-slot. Base: ad-slot (custom project block).
 ...
 * {path}.plain.html), validated against migration-work/block-context/ad-slot/source.html:
 *   <div class="ad-slot [criteo]">
 *     <div>                                   <- row
 *       <div><picture>..</picture></div>      <- cell: sponsored creative (alt = ad copy)
 *     </div>
 *   </div>
...
export default function parse(element, { document }) {
  ...
  const block = WebImporter.Blocks.createBlock(document, { name: 'ad-slot', variants, cells });
